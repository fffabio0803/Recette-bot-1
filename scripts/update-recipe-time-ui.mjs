...
if (!listing.includes('src="/assets/recipe-time.js')) listing = listing.replace('</head>', '<script src="/assets/recipe-time.js?v=20260906"></script>\n</head>');
listing = listing.replace(/src="\/assets\/recipe-time\.js(?:\?[^"\s]*)?"/g, 'src="/assets/recipe-time.js?v=20260906"');
